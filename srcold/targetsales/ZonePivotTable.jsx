...
function ZonePivotTable({ ZonewiseTotal }) {
  ...
  console.log(ZonewiseTotal, "ZonewiseTotalsss");
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-2xl border border-gray-100 mb-5" style={{marginBottom:"100px"}}>
      {/* Header */}
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <TableIcon className="w-7 h-7 text-blue-600" />
          <h3 className="text-2xl font-bold text-gray-800">
            Combined (PP+PE) Performance
          </h3>
        </div>
            ...
            <tr className="odd:bg-white even:bg-slate-50/70 font-medium">
              ...
              {ZonewiseTotals.map((zone) => (
                <td
                  ...
                  className="p-2 border-b border-r border-slate-200 font-bold"
                >
                  {zone.totalAchievement}
                </td>
              ))}
              <td className="p-2 border-b border-r border-slate-200 font-bold">
                {ZonewiseTotal?.totalZoneAchievement}
              </td>
            </tr>
          </tbody>
        </table>
