...
// console.log("login response data", data)
  ...
  //   try {
  //     // let res = await props.sessionContext.get(
  //     //   "MIS/Account/Login?" +
  //     //     "UserName=" +  username +
  //     //     "&Password=" + password +
  //     //     "&authKey=1.0&captchaStatus=true"
  //     // );
  ...
  //     console.log("loginurl",d)

  //     if (response.alertMessage === "Success") {
  ...
  //       // else {
  //       //   if (res.warehouseId === 1) {
  //       //     usenavigate("/paradeepdashboard");
  //       //   } else if (res.warehouseId === 7) {
  //       //     usenavigate("/dashboard");
  //       //   }
  //       // }

  //     } else {
  //         toast(response.alertMessage);
  //     }
  //     setResult(response);
  //   } catch (error) {
...
//     try {
//       // 1️⃣ Call intranet authentication API
...
//       // if (!d.auth_status) {
//       //   setError("Incorrect credentials. Please check your Employee No and Password.");
//       //   return;
//       // }

//       // 2️⃣ Call internal login API
//       try {
//         await axios.post("/customeranalytics/api/login", {
//           email: username,
//           password,
//         });
...
//         console.error(
//           "Internal login API error:",
//           internalApiError.response?.data || internalApiError.message
//         );
//         setError(
//           internalApiError.response?.data?.Message ||
//             "An unexpected error occurred while creating your session."
//         );
//       }
//     } catch (intranetApiError) {
//       console.error(
//         "External intranet login API error:",
//         intranetApiError.message
//       );
